...
// ======================== STATEMENTS ===============================//
  ...
  public void exitIfStatement(LittleCParser.IfStatementContext ctx) {
    ...
    if (ctx.OPEN_BRACE() != null && ctx.CLOSE_BRACE() != null) {
      ...
      // Add each child of the "then" tree to a new node that gets added as a SEQ
      // call.
  ...
  public void exitFunctionPrototype(LittleCParser.FunctionPrototypeContext ctx) {
    ...
    if (ctx.ID() != null) {
      ...
      LinkedHashMap<String, CoreType> args = new LinkedHashMap<String, CoreType>();
      ...
      if (p != null) {
        for (int i = 0; i < p.getChildCount(); i += SPACE_PER_ARG) {
          CoreType varDataType = CoreType.getTypeFromString(p.getChild(i).getText());
  ...
  public void exitReturnStatement(LittleCParser.ReturnStatementContext ctx) {
    ...
    if ((this.syntaxTree.getFlags() & LCMasks.RETURN_INT_MASK) != 0) {
      fnRetType = CoreType.INT;
    } else if ((this.syntaxTree.getFlags() & LCMasks.RETURN_CHAR_MASK) != 0) {
      fnRetType = CoreType.CHAR;
    } else {
      fnRetType = CoreType.VOID;
    }
    ...
    if (ctx.expr() != null) {
      if (!retExpr.getType().equals(fnRetType)) {
        if (!fnRetType.equals(CoreType.VOID)) {
          this.syntaxTree.printError(ctx,
  ...
  public void exitAssignStatement(LittleCParser.AssignStatementContext ctx) {
    ...
    CoreType lvalueType = this.symbolTable.getSymbolEntry(id).getVarType();
    ...
    if (ctx.expr().size() == 2) {
      ...
      // But we can do x[0] = 5;
      if (!this.symbolTable.getSymbolEntry(id).getVarType().isArray()) {
      ...
      LCArrayIndexNode arrayReference = new LCArrayIndexNode(ctx, lvalueType, arrayIdentifier,
...
// ======================== EXPRESSIONS ===============================//
  ...
  public void enterExprTerm(LittleCParser.ExprTermContext ctx) {
    ...
    if (ctx.term() != null) {
      if (ctx.term().ID() != null) {
        ...
        if (this.symbolTable.hasSymbol(id)) {
          CoreType varType = this.symbolTable.getSymbolEntry(id).getVarType();
      ...
      // Check for the existence of a literal.
        ...
        if (ctx.term().INTLIT() != null) {
          ...
          constantLiteral = new LCConstantLiteralNode(ctx, intLit, CoreType.INT);
          ...
          constantLiteral = new LCConstantLiteralNode(ctx, literalValue, CoreType.CHAR);
        } else if (ctx.term().STRINGLIT() != null) {
          constantLiteral = new LCConstantLiteralNode(ctx, ctx.term().STRINGLIT().getText(), CoreType.CHAR_ARRAY);
        }
  ...
  public void exitExprPreOp(LittleCParser.ExprPreOpContext ctx) {
    ...
    CoreType idType = this.symbolTable.getSymbolEntry(id).getVarType();
    String op = "";
  ...
  public void exitExprUnary(LittleCParser.ExprUnaryContext ctx) {
    ...
    if (type.isInt() || type.isChar()) {
      ...
      if (ctx.SIZE_OP() != null) {
        op = "#";
        type = CoreType.INT; // We have to change the type since it's different here.
      } else {
        this.syntaxTree.printError(ctx, "invalid unary operator for r-value expression of type " + type + ".");
        return;
      }
  ...
  public void exitExprBinaryOp(LittleCParser.ExprBinaryOpContext ctx) {
    ...
    if (hasBinaryOperator(ctx)) {
      ...
      boolean lStr = lexpr.getType().isArray();
      boolean rStr = rexpr.getType().isArray();
      
      System.out.println(lexpr.getType());
      System.out.println(rexpr.getType());
  ...
  public void exitTerm(LittleCParser.TermContext ctx) {
    ...
    // Here we check for the existence of a literal.
      ...
      if (ctx.INTLIT() != null) {
        ...
        constantLiteral = new LCConstantLiteralNode(ctx, ctx.STRINGLIT().getText(), CoreType.CHAR_ARRAY);
      }
      this.values.put(ctx, constantLiteral);
    }
  }
  ...
  public void exitExprArray(LittleCParser.ExprArrayContext ctx) {
    ...
    CoreType arrayType = this.symbolTable.getSymbolEntry(id).getVarType();
    ...
    LCArrayIndexNode arrayIndexNode = new LCArrayIndexNode(ctx, arrayType, arrayIdentifier, indexExpr);
...
// ======================== DECLARATIONS ===============================//
  ...
  public void exitIntDeclaration(LittleCParser.IntDeclarationContext ctx) {
    ...
    if (ctx.ID() != null) {
      ...
      LCVariableDeclarationNode intDeclarationNode = new LCVariableDeclarationNode(ctx, this.symbolTable, lValue,
          CoreType.INT, storageClass, literalValue);
  ...
  public void exitIntArrayDeclaration(LittleCParser.IntArrayDeclarationContext ctx) {
    ...
    if (ctx.ID() != null) {
      String lValue = ctx.ID().getText();
      CoreType type = new CoreType(CoreType.INT, Integer.parseInt(ctx.INTLIT().getText()));
      String storageClass = LCUtilities.getStorageClassType(ctx.EXTERN(), ctx.STATIC());
      Object literalValue = null;
  ...
  public void exitIntArrayRefDeclaration(LittleCParser.IntArrayRefDeclarationContext ctx) {
    ...
    if (ctx.ID() != null) {
      String lValue = ctx.ID().getText();
      CoreType type = CoreType.INT_ARRAY;
      String storageClass = LCUtilities.getStorageClassType(ctx.EXTERN(), ctx.STATIC());
      Object literalValue = null;
  ...
  public void exitCharDeclaration(LittleCParser.CharDeclarationContext ctx) {
    ...
    if (ctx.ID() != null) {
      ...
      LCVariableDeclarationNode charDeclarationNode = new LCVariableDeclarationNode(ctx, this.symbolTable, lValue,
          CoreType.CHAR, storageClass, literalValue);
  ...
  public void exitStringDeclaration(LittleCParser.StringDeclarationContext ctx) {
    ...
    if (ctx.ID() != null) {
      String lValue = ctx.ID().getText();
      CoreType type = new CoreType(CoreType.CHAR, Integer.parseInt(ctx.INTLIT().getText()));
      String storageClass = LCUtilities.getStorageClassType(ctx.EXTERN(), ctx.STATIC());
      Object literalValue = null;
  ...
  public void exitStringRefDeclaration(LittleCParser.StringRefDeclarationContext ctx) {
    ...
    if (ctx.ID() != null) {
      String lValue = ctx.ID().getText();
      CoreType type = CoreType.CHAR_ARRAY;
      String storageClass = LCUtilities.getStorageClassType(ctx.EXTERN(), ctx.STATIC());
      Object literalValue = null;
  ...
  public LCSyntaxTree getSyntaxTree() {
    ...
    if (this.symbolTable.hasSymbol("main") && this.symbolTable.getSymbolEntry("main").getVarType().equals(CoreType.VOID)) {
  ...
  private void addDefaultGlobalFunctions() {
    ...
    args.add(new LCVariableIdentifierNode(null, symbolTable, "str", CoreType.CHAR_ARRAY));
    this.symbolTable.addSymbol("prints", new SymbolEntry("FNDEF", CoreType.VOID, "extern", args));
    args = new LinkedList<>();

    /* Adds the printd function. */
    args.add(new LCVariableIdentifierNode(null, symbolTable, "number", CoreType.INT));
    this.symbolTable.addSymbol("printd", new SymbolEntry("FNDEF", CoreType.VOID, "extern", args));
    args = new LinkedList<>();

    /* Adds the printc function. */
    args.add(new LCVariableIdentifierNode(null, symbolTable, "number", CoreType.CHAR));
    this.symbolTable.addSymbol("printc", new SymbolEntry("FNDEF", CoreType.VOID, "extern", args));
    args = new LinkedList<>();

    /* Adds the printf function. */
    args.add(new LCVariableIdentifierNode(null, symbolTable, "number", CoreType.FLOAT));
    this.symbolTable.addSymbol("printf", new SymbolEntry("FNDEF", CoreType.VOID, "extern", args));
    args = new LinkedList<>();

    /* Adds the read() function. */
    this.symbolTable.addSymbol("read", new SymbolEntry("FNDEF", CoreType.INT, "extern", args));
    args = new LinkedList<>();

    /* Adds the readc() function. */
    this.symbolTable.addSymbol("readc", new SymbolEntry("FNDEF", CoreType.CHAR, "extern", args));
    args = new LinkedList<>();

    /* Adds the readf() function. */
    this.symbolTable.addSymbol("readf", new SymbolEntry("FNDEF", CoreType.FLOAT, "extern", args));
    args = new LinkedList<>();

    /* Add the readline() function. */
    args.add(new LCVariableIdentifierNode(null, symbolTable, "str", CoreType.CHAR_ARRAY));
    this.symbolTable.addSymbol("readline", new SymbolEntry("FNDEF", CoreType.VOID, "extern", args));
  }

  /**
   * Returns whether or not there is a non-null binary operator node in the
   * ExprBinaryOpContext object.
   * 
  ...
  /**
   * Returns the appropriate string binary operator in the ExprBinaryOpContext. We
   * have to painstakingly check each node for "nullness".
   * 
   * @param ctx - ExprBinaryOpContext object.
   * 
