...
public class ICodeTester {
    ...
    /**
     * Cleanup function. I originally used this with
     * the @AfterEach tag, but because there are group
     * tests that rely on a cleanup, I had to force
     * this into a function and call it before the assertion
     * in runICTest(...). 
     * 
